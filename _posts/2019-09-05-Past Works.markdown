---
layout: post
title: <font size="7em"> <font style="color:Tomato;"> RESEARCH EXPERIENCE </font></font>
categories: update
---
<br><font size="6em"><b>
...
<br>
<br><br><br>
&nbsp; • Modified the design of the circuit to be more &nbsp;stretchable.<br>
...
<h1 style="background-color:LightCyan; text-align:center; color:black;"><font size="6em"><b>
Nano electronics device Lab (NDL) Intern </b></font></h1>
...
•	Participated in cancer cell separating microfluidics research, tested microfluidic plate to optimize the injection speed of the blood model and the cancer stem cells/normal cells separate rate (second half).<br>
</font><br>
<br>
